...
def process_explore_assistant_request(auth_header: str, request_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        # Get model-appropriate defaults
        model_defaults = get_model_generation_defaults(vertex_model)
        vertex_temperature = float(request_data.get('vertex_temperature', model_defaults["temperature"]))
        vertex_top_p = float(request_data.get('vertex_top_p', model_defaults["topP"]))
        vertex_top_k = int(request_data.get('vertex_top_k', model_defaults["topK"]))
